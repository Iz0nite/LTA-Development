...
<html lang="en" dir="ltr">
	<head>
		<title>LTA-development - Delivery man Payment</title>
	...
	<body class="preload">
		...
		<main>
			...
			<script src="https://www.paypal.com/sdk/js?client-id=ASXCs8-S37AEIDA8s3oJs_E1xfc1BaHnHYWb-YtjDkwCqbi_D3Z-zQGjDKWPUCTw3wL-UNNuvDgPofXa&currency=EUR">
				...
				let PAYPAL_CLIENT = 'ASXCs8-S37AEIDA8s3oJs_E1xfc1BaHnHYWb-YtjDkwCqbi_D3Z-zQGjDKWPUCTw3wL-UNNuvDgPofXa';
				let PAYPAL_SECRET = 'EJdB9p1ythp3A4ZcnNliUYFKbeU_h26vxmuh6KpNC5ioekXPsfELtFVOg3bIBMxBYhbz89FnOKMG_CXd';
